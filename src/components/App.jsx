...
export default function App() {
  const [{ questions, status, index, answer, points }, dispatch] = useReducer(reducer, initialeState)
  ...
  return (
    <div className="app">
      ...
      <Main>
        ...
        {status === 'finish' && <FinishScreen points={points} maxPossiblePoints={maxPossiblePoints} />}
      </Main>
    </div>
  )
}
